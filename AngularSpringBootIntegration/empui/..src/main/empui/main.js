...
let EmployeeService = class EmployeeService {
    constructor(http) {
        this.http = http;
        this.url = "http://localhost:8080/ec/employees";
    }
    getEmployeeDetails() {
...
module.exports = __webpack_require__(/*! D:\git\AngularSpringBootIntegration\AngularSpringBootIntegration\empui\src\main.ts */"./src/main.ts");
